...
namespace Maddin\Cups\Tests\Units\Builder;
 ...
 * Class Builder
 *
 * @package Maddin-68\Cups\Tests\Units\Builder
 */
class Builder extends atoum\test
{
    ...
    {
        $builder = new \Maddin\Cups\Builder\Builder();
        ...
        $this->exception(
          ...
          ->isInstanceOf('\Maddin-68\Cups\CupsException')
